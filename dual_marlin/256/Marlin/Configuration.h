...
#define PID_MAX 255 // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  #define PID_dT 0.125 //sampling period of the temperature routine
...
const bool Y_MIN_ENDSTOP_INVERTING = false; // set o true to invert the logic of the endstop.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 1593,100 } //  1672/1,049375                             old:{78.7402,78.7402,200.0*8/3,760*1.1} default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {400, 400, 5, 50}   // {500, 500, 5, 25} (mm/sec)
