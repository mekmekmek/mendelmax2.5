...
#define STRING_VERSION_CONFIG_H "Welkome" __DATE__ " " __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "Mekmekmek" //Who made the changes.
...
// Mendel Parts V9 on 12V    just presets
